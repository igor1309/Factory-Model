...
struct NameGroupCodeNoteEditorSection_Previews: PreviewProvider {
    static var previews: some View {
        Form {
            NameGroupCodeNoteEditorSection(Base.example)
            
            NameGroupCodeNoteStringEditorSection(name: .constant("Name"), group: .constant("Group #1"), code: .constant("Code #1"), note: .constant("Here goes note…"))
        }
